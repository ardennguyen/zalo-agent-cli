...
> [!TIP]
> **MCP Server (AI Agent Integration)** — v1.0.0 hỗ trợ Model Context Protocol cho Claude Code và các MCP client:
> ```bash
...
> [!NOTE]
> **Local Cache & Full-Text Search** — v1.1.0 thêm caching cục bộ và tìm kiếm toàn văn bản:
> ```bash
...
Tất cả lệnh hỗ trợ `--json`. Tài liệu đầy đủ: **[Wiki](https://github.com/ardennguyen/zalo-agent-cli/wiki)**
...
| `poll` | Tạo, bỏ phiếu, đóng khảo sát | [Khảo sát](https://github.com/ardennguyen/zalo-agent-cli/wiki/Kh%E1%BA%A3o-S%C3%A1t) |
| `reminder` | Tạo, sửa, xóa nhắc nhở | [Nhắc nhở](https://github.com/ardennguyen/zalo-agent-cli/wiki/Nh%E1%BA%AFc-Nh%E1%BB%9F) |
| `auto-reply` | Quản lý trả lời tự động | [Trả lời tự động](https://github.com/ardennguyen/zalo-agent-cli/wiki/Tr%E1%BA%A3-L%E1%BB%9Di-T%E1%BB%B1-%C4%90%E1%BB%99ng) |
...
- **Local cache** — `conv recent` & `msg history` đọc offline, không tốn băng thông
...
> [!TIP]
> **MCP Server (AI Agent Integration)** — v1.0.0 adds Model Context Protocol support for Claude Code and MCP clients:
> ```bash
> zalo-agent mcp start              # stdio (local Claude Code)
> zalo-agent mcp start --http 3847 --auth your-secret  # HTTP (VPS)
> ```
...
> [!NOTE]
> **Local Cache & Full-Text Search** — v1.1.0 adds local caching and full-text search:
> ```bash
...
Full docs: **[Wiki](https://github.com/ardennguyen/zalo-agent-cli/wiki)**
...
| `poll` | Create, vote, lock polls | [Polls](https://github.com/ardennguyen/zalo-agent-cli/wiki/Polls) |
| `reminder` | Create, edit, remove reminders | [Reminders](https://github.com/ardennguyen/zalo-agent-cli/wiki/Reminders) |
| `auto-reply` | Auto-reply rules | [Auto-Reply](https://github.com/ardennguyen/zalo-agent-cli/wiki/Auto-Reply) |
